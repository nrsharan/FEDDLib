...
class Diffusion : public Problem<SC,LO,GO,NO>  {
...
public:
    ...
    Diffusion(const DomainConstPtr_Type &domain, std::string FEType, ParameterListPtr_Type parameterList, vec2D_dbl_Type diffusionTensor ,bool vectorLaplace = false);
