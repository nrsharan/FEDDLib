#!/bin/bash -l
#
#SBATCH --job-name=plassWD20
#SBATCH --comment="PlassWD20"
#SBATCH --time=105:00:00          ### time the job will appr. run
...
srun --mpi=pmi2 ./problems_artery_plass_withDrug_pd_20.exe