#!/bin/bash -l
#
#SBATCH --job-name=narulaWD10
#SBATCH --comment="NarulaWD10"
#SBATCH --time=110:00:00          ### time the job will appr. run
...
srun --mpi=pmi2 ./problems_artery_narula_withDrug_pd_10.exe