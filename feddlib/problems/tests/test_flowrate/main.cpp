...
int main(int argc, char *argv[])
{
...

    {
        ...
        // Fluid-RW
        {
            ...
            bcFactory->addBC(parabolicInflowDirection3D, 4, 0, domainFluidVelocity, "Dirichlet", dim, parameter_vec, solutionLaplaceConst, true , parabolicInflow3D); // inflow 


            bcFactory->addBC(parabolicInflowDirection3D, 2, 0, domainFluidVelocity, "Dirichlet", dim, parameter_vec, solutionLaplaceConst, true , parabolicInflow3D); // inflow 
